<template>
	<section class="child_page">
		...
		<section class="newmessage">
			<h1 class="chatrecord">Address Book</h1>
			<ul>
				<li>
					<div>加Me为朋友时需要验证</div>
				...
				<li>
					<div>Address Book黑名单</div>
				</li>
			</ul>
			<h1 class="chatrecord">朋友圈</h1>
			<ul>
				<li>
					<div>不让他（她）看Me的朋友圈</div>
				</li>
				<li>
					<div>不看他（她）Me的朋友圈</div>
				</li>
				<li>
					<div>朋友分组</div>
				</li>
				...
				<li class="spacial_li">
					...
					<div class="newshow_text">
						关闭后，将隐藏“Discover”中的朋友圈入口，你发的朋友圈不会清空，朋友仍可以看到
					</div>
				</li>
				<li class="spacial_li" v-if="warn">
					...
					<div class="newshow_text">
						关闭后，有朋友更新照片时，界面下方的“Discover”切换按钮上不在出现红点提示
					</div>
				</li>
			</ul>
		</section>
