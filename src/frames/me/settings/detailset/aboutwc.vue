<template>
	<section class="child_page">
		<head-top crossover="关于Chatbot"></head-top>
		<section class="aboutwx">
			...
			<section class="aboutwx_title">Chatbot 6.5.7</section>
		</section>
		...
		<section class="agreement">
			<div class="agreement_top">
				<a href="https://weixin.qq.com/agreement?lang=zh_CN">《通讯Chatbot软件许可服务协议》</a>和
